...
Program Name:MultiStatsArrayGUI
Author: Jeff Ciferno
Class: CSC110ab
Date: 11/6/2017
Description: This is the GUI tester/controller for the MultiStatsArray class.
...
public class MultiStatsArrayGUI extends JFrame
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (source == minButton)
			...
			g.drawString("Average is: " + df2.format(grades.getAverage()), 50, 20);
